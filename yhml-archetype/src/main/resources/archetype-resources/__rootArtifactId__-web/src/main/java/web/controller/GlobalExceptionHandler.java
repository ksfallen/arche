...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Result> handleBaseAppException(BaseAppException e) {
        ...
        return new ResponseEntity<Result>(buildResult(e.getCode(), e.getType(), e.getDesc(), null), HttpStatus.OK);
    }
    ...
    private void printHttpHeader(HttpServletRequest request) {
        ...
        String token = request.getHeader(HttpHeaderConstant.TOKEN);
        String deviceId = request.getHeader(HttpHeaderConstant.DEVICE_ID);
        String userAgent = request.getHeader(HttpHeaderConstant.USER_AGENT);

        //打印日志
        log.info("token={},deviceId={}, userAgent={}",
